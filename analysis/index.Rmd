...
* New Samples: Jackson_Lab_Reinholdt_MURGIGV01_20210726
	+ [Total Samples: 59](0.1_samples_batch_20210726.html)
...
* redone
	...
	+ Concordance
* new samples
	+ [Figures](0.2_haplotype_comparison_bqc_reinholt.html)
	+ Concordance
...
* Step 1: Sample QC 
	...
	+ new samples
		- [All Samples in File](2.1_sample_bqc_wcont_reinholt.html)
		- [Project Only Samples](2.1_sample_bqc_wcont_reinholt.html)
* Step 2: SNP QC (Monomorphic, Genotype Error & Missing Data)
	...
	+ new samples
		- [All Samples in File](2.2.1_snp_qc_wcont_reinholt.html)
		- [Project Only Samples](2.2.1_snp_qc_wcont_reinholt.html)
