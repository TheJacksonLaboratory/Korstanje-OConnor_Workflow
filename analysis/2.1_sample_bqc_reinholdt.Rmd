---
title: "Step 1: Sample QC [Reinholdt Samples]"
...
filepathp = '/Users/corneb/Documents/MyJax/CS/Projects/Korstanje-Oconnor/haplotype.reconstruction/output_cell.data/'
filepaths = '/Users/corneb/Documents/MyJax/CS/Projects/Korstanje-Oconnor/haplotype.reconstruction/output_cell.data/'
#setwd(filepaths)
...
gmf <- read_cross2("/Users/corneb/Documents/MyJax/CS/Projects/Korstanje-Oconnor/haplotype.reconstruction/output_cell.data/qtl2/gm.json")
...
#save into pdf
pdf(file = "output/Percent_missing_genotype_data_reinholt.pdf", width = 20, height = 20)
...
save(percent_missing,file = "data/percent_missing_id_reinholt.RData")
...
save(summary.cg,file = "data/summary.cg_reinholt.RData")

#pdf(file = "output/Proportion_matching_genotypes_before_removal_of_bad_samples_reinholt.pdf", width = 20, height = 20) 
...
#load the intensities.fst_reinholt.RData
#load("data/intensities.fst_reinholt.RData")
...
#load the intensities.fst_reinholt.RData
#load("data/heh/intensities.fst_reinholt.RData")
#X and Y channel
...
#load("data/pr_reinholt.RData")
pr<-readRDS(paste0(filepaths,"cell_gig_data__GigaMUGA_genoprobs_36state.rds"))
#load("data/m_reinholt.RData")
#load("data/nxo_reinholt.RData")

m <- maxmarg(pr)
nxo <- count_xo(m)
#save(pr, file = "data/pr_reinholt.RData")
#str(pr)
save(m, file = "data/m_reinholt.RData")
save(nxo, file = "data/nxo_reinholt.RData")

e <- calc_errorlod(gm, pr)
#str(e)
e <- do.call("cbind", e)
save(e, file = "data/e_reinholt.RData")

snpg <- predict_snpgeno(gm, m)
snpg <- do.call("cbind", snpg)
save(snpg, file = "data/snpg_reinholt.RData")
...
pdf(file = "output/number_crossover_reinholt.pdf")
...
iplot(seq_along(errors_ind), errors_ind, indID=lab,
      chartOpts=list(xlab="Mouse", ylab="Percent genotyping errors", ylim=c(0, 15),
                     axispos=list(xtitle=25, ytitle=50, xlabel=5, ylabel=5)))
save(errors_ind, file = "data/errors_ind_reinholt.RData")
...
pdf(file = "output/Percent_genotype_errors_obs_vs_predicted_reinholt.pdf",width = 20, height = 20) 
par(pty="s")
err_direct <- rowMeans(snpgn != gobs, na.rm=TRUE)*100
errors_ind_0 <- rowSums(e > 0)[rownames(gm$covar)]/n_typed(gm)*100
par(mar=c(4.1,4.1,0.6, 0.6))
...
save(qc_info, bad.sample, file = "data/qc_info_bad_sample_reinholt.RData")
...
save(gm_samqc, file = "data/gm_samqc_reinholt.RData")
...
save(e,g,snpg, file = "data/e_g_snpg_samqc_reinholt.RData")
#save(e,g, file = "data/e_g_snpg_samqc_reinholt.RData")
