---
title: "Samples [Batch: MURGIGV01_20210726]"
...
filepathg = '/Users/corneb/Documents/MyJax/CS/Projects/Korstanje-Oconnor/Neogen/Jackson_Lab_Reinholdt_MURGIGV01_20210726/'
...
samphen <- samples[samples$Directory == "Jackson_Lab_Reinholdt_MURGIGV01_20210726",]
...
#1  9 23 24 28 39 40 43 45 47 55 56 57 58 59 60
...
summary[c(1:17,31)] %>%
  ...
  row_spec(37,color= "white",background = "red") %>%
  row_spec(39,color= "white",background = "red") %>%
  row_spec(47,color= "white",background = "red") %>%
...
summary[c(1,22:24)] %>%
  ...
  row_spec(24,color= "white",background = "blue") %>%
  row_spec(28,color= "white",background = "blue") %>%
  row_spec(39,color= "white",background = "blue") %>%
  row_spec(40,color= "white",background = "blue") %>%
  row_spec(43,color= "white",background = "blue") %>%
  row_spec(45,color= "white",background = "blue") %>%
  row_spec(47,color= "white",background = "blue") 

#1  9 23 24 28 39 40 43 45 47
