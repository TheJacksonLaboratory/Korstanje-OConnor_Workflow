---
title: "Samples [Batch: MURGIGV01_20201111]"
...
filepathg = '/Users/corneb/Documents/MyJax/CS/Projects/Oconnor/Neogen/Jackson_Lab_Korstanje_MURGIGV01_20201111/'
...
summary[c(1:17,31)] %>%
  ...
  row_spec(19,color= "white",background = "red") %>%
  row_spec(21,color= "white",background = "red") %>%
  row_spec(38,color= "white",background = "red") %>%
  row_spec(59,color= "white",background = "red") %>%
  row_spec(95,color= "white",background = "red") %>%
  row_spec(96,color= "white",background = "red") %>%
  row_spec(141,color= "white",background = "red") %>%
  row_spec(142,color= "white",background = "red") %>%
  row_spec(145,color= "white",background = "red") %>%
  row_spec(168,color= "white",background = "red") %>%
  row_spec(169,color= "white",background = "red") %>%
...
summary[c(1,22:24)] %>%
  ...
  row_spec(21 ,color= "white",background = "blue")  %>%
  row_spec(38 ,color= "white",background = "blue")  %>%
  row_spec(59 ,color= "white",background = "blue")  %>%
  row_spec(62 ,color= "white",background = "blue")  %>%
  row_spec(64 ,color= "white",background = "blue")  %>%
  row_spec(70 ,color= "white",background = "blue")  %>%
  row_spec(72 ,color= "white",background = "blue")  %>%
  row_spec(89 ,color= "white",background = "blue")  %>%
  row_spec(93 ,color= "white",background = "blue")  %>%
  row_spec(105 ,color= "white",background = "blue")  %>%
  row_spec(109 ,color= "white",background = "blue")  %>%
  row_spec(152 ,color= "white",background = "blue")  %>%
  row_spec(175 ,color= "white",background = "blue")  %>%
  row_spec(187 ,color= "white",background = "blue")  %>%
  row_spec(191 ,color= "white",background = "blue")  #%>%
