---
title: "Samples [Batch: MURGIGV01_20210604]"
...
filepathg = '/Users/corneb/Documents/MyJax/CS/Projects/Korstanje-Oconnor/Neogen/NeoGen/Jackson_Lab_Korstanje_MURGIGV01_20210604/'
...
samphen <- samples[samples$Directory == "Jackson_Lab_Korstanje_MURGIGV01_20210604",]
...
summary[c(1:17,31)] %>%
  ...
  row_spec(6,color= "white",background = "red") %>%
  row_spec(13,color= "white",background = "red") %>%
  row_spec(14,color= "white",background = "red") %>%
  row_spec(18,color= "white",background = "red") %>%
