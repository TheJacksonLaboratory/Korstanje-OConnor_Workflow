...
save(percent_missing,file = "data/percent_missing_id.RData")
...
save(summary.cg,file = "data/summary.cg.RData")
...
save(snpg, file = "data/snpg.RData")
...
save(gm_samqc, file = "data/gm_samqc.RData")
...
#save(e,g, file = "data/e_g_snpg_samqc.RData")
