---
title: "Samples [Batch: MURGIGV01_20210211]"
...
#for(i in 100){
  ...
  #sample Information
  totphensam <- merge(totall, samphen, by.x=c("Neogen_Sample_ID"), by.y=c("Unique.Sample.ID")) 
...
which(summary$cr <.90)
#[1]  29  44  45  64  68 124 141 156 173 181 182 192 194 196 198 200 204 207 218 223 231 254 271
...
#2  16  29  37  44  60  68  90  91  92 141 165 183 190 194 254 271 278
...
summary[c(1:17,31)] %>%
  ...
  row_spec(29,color= "white",background = "red") %>%
  row_spec(44,color= "white",background = "red") %>%
  row_spec(45,color= "white",background = "red") %>%
  row_spec(64,color= "white",background = "red") %>%
  row_spec(68,color= "white",background = "red") %>%
  row_spec(124,color= "white",background = "red") %>%
  row_spec(156,color= "white",background = "red") %>%
  row_spec(173,color= "white",background = "red") %>%
  row_spec(181,color= "white",background = "red") %>%
  row_spec(182,color= "white",background = "red") %>%
  row_spec(192,color= "white",background = "red") %>%
  row_spec(194,color= "white",background = "red") %>%
  row_spec(196,color= "white",background = "red") %>%
  row_spec(198,color= "white",background = "red") %>%
  row_spec(200,color= "white",background = "red") %>%
  row_spec(204,color= "white",background = "red") %>%
  row_spec(207,color= "white",background = "red") %>%
  row_spec(218,color= "white",background = "red") %>%
  row_spec(223,color= "white",background = "red") %>%
  row_spec(231,color= "white",background = "red") %>%
  row_spec(254,color= "white",background = "red") %>%
  row_spec(271,color= "white",background = "red") %>%
  row_spec(194,color= "white",background = "red") #%>%

#29  44  45  64  68 124 141 156 173 181 182 192 194 196 198 200 204 207 218 223 231 254 271
...
summary[c(1,22:24)] %>%
  ...
  row_spec(12 ,color= "white",background = "blue")  %>%
  row_spec(16 ,color= "white",background = "blue")  %>%
  row_spec(29 ,color= "white",background = "blue")  %>%
  row_spec(37 ,color= "white",background = "blue")  %>%
  row_spec(44 ,color= "white",background = "blue")  %>%
  row_spec(60 ,color= "white",background = "blue")  %>%
  row_spec(68 ,color= "white",background = "blue")  %>%
  row_spec(90 ,color= "white",background = "blue")  %>%
  row_spec(91 ,color= "white",background = "blue")  %>%
  row_spec(92 ,color= "white",background = "blue")  %>%
  row_spec(141 ,color= "white",background = "blue")  %>%
  row_spec(165 ,color= "white",background = "blue")  %>%
  row_spec(183 ,color= "white",background = "blue")  %>%
  row_spec(190 ,color= "white",background = "blue")  %>%
  row_spec(194 ,color= "white",background = "blue")  %>%
  row_spec(254 ,color= "white",background = "blue")  %>%
  row_spec(271 ,color= "white",background = "blue")  %>%
  row_spec(278 ,color= "white",background = "blue")  #%>%
